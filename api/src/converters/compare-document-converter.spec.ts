import { ICompareDocumentConverter, compareDocumentConverterFactory } from '@/converters/compare-document-converter';
import { matchDocument, betDocument, teamDocument, compareResponse } from '@/common/test-data-factory';
