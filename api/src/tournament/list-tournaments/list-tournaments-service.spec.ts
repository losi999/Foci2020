import { IListTournamentsService, listTournamentsServiceFactory } from '@/tournament/list-tournaments/list-tournaments-service';
...
import { TournamentDocument, TournamentResponse } from '@/shared/types/types';
